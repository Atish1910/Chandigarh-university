 ...
 <!-- Navbar Start -->
 <div class="container-fluid py-2 sticky-top h_nav">
     <div class="container">
         <nav class="navbar navbar-expand-lg  navbar-light p-lg-0">
             ...
             <div class="collapse navbar-collapse justify-content-end " id="navbarCollapse">
                 ...
                 <div class="navbar-nav">
                     ...
                     <a href="#Programme-2024-25" class="nav-item nav-link">Programme 2024-25</a>
                     <a href="#admission-details" class="nav-item nav-link">Admission Details</a>
                     <a href="#n_contact" class="nav-item nav-link">Contact Us</a>
                     <div class="d-lg-block">
                         <a href="<?= LINK; ?>" class="btn c_btn rounded-pill py-2 px-3 ms-2 mt-3 text-white"
                             data-bs-toggle="modal" data-bs-target="#exampleModal">Enquire Now</a>
                     </div>
                 </div>
             </div>

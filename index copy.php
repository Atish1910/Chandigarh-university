                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="form-group">
                                                    <select class="form-select form_deptart" name="n_dept">
                                                        ...
                                                        <?php
                                                            $a = array("Aerospace","Biotechnology","Biotechnology-Lateral-Entry","Computer-Science-Engineering-Lateral-Entry","cs-Engineering-cs-Business-Systems");
                                                            $b = array("Bachelor of Engineering (Aerospace Engineering)","Bachelor of Engineering (Biotechnology) ","Bachelor of Engineering (Biotechnology)- Lateral Entry","Bachelor of Engineering (Computer Science & Engineering) - Lateral Entry","Bachelor of Engineering (Computer Science and Engineering) (Computer Science and Business Systems) (In association with TCS)");
                                                            for ($i=0; $i < count($a); $i++) {        
                                                        ?>
                                                            <option data-course="engineering"
                                                            value="<?= $a[$i];?>"><?= $b[$i];?></option>
                                                        <?php 
                                                            }
                                                        ?>
                                                        </optgroup>
                                            ...
                                            <div class="col-md-12 text-center nav_01 d-grid table_css">
                                                ...
                                                <div class="modal fade"  id="exampleModal" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog form_deptart  modal-lg">

                                                        <div class="modal-content">
                                                            <div class="modal-header bg-blue text-start">
                                                                <h1 class="modal-title fs-5  text-white"
                                                                    id="exampleModalLabel">
                                                                    Program Details for Bachelor of Engineering
                                                                    (Aerospace Engineering)</h1>
                                                            ...
                                                            <div class="modal-body text-start">
                                                                <div class="">
                                                                    ...
                                                                    <p><b>Eligibility- </b> 10+2 with Physics and
                                                                        Mathematics as compulsory subjects along with
                                                                        one of the following subjects: Chemistry /
                                                                        Biotechnology / Computer Science /
                                                                        Biology/Informatics Practice/Information
                                                                        Technology with at least 50% marks in the
                                                                        aggregate.</p>
